...
<body>
	...
	<c:if test="${ ! empty alertMsg }">
		...
		alertify.alert("Message","${alertMsg}");
            ...
            <form action="login.me" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text"     name="userId" class="form-control mb-2 mr-sm-2" 
                    	   placeholder="아이디를 입력해주세요" id="userId"> <br>
                    
                    <label for="userPwd" class="mr-sm-2">비밀번호:</label>
                    <input type="password" name="userPwd" class="form-control mb-2 mr-sm-2" 
                    	   placeholder="비밀번호를 입력해주세요" id="userPwd">
